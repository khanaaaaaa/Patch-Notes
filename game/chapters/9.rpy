label version_09:
    ...
    narrator "Past the invisible wall at the north ede of town."
    ...
    narrator "Sticky notes covering the monitior."
    narrator "Medical bills on the floor."
    narrator "Unpaid rent notice under the floor."
    ...
    narrator "He never knew they were concious."
